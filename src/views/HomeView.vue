...
const validateReason = () => {
  ...
  if (reasonText.includes('friend')) {
    ...
    errors.value.reason = null;  // Clear any existing error messages
  } else {
    errors.value.reasonSuccess = null;
  }

  // Additional validation can be added here if needed (e.g., check if the field is empty)
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="errors.reasonSuccess" class="text-success">{{ errors.reasonSuccess }}</div>
          </div>
...
<style>
/* Removed the container styles as they have been moved to App.vue */
</style>
